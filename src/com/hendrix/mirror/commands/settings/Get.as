package com.hendrix.mirror.commands.settings
{
  ...
  import com.hendrix.mirror.resources.SettingsItem;
  ...
  public class Get extends MirrorRequest
  {
    ...
    override public function execute($onComplete:Function=null, $onError:Function=null):void
    {
      new RequestBuilder(this).GET()
                              .url(SConfig.HOST + "/mirror/v1/settings/" + _id)
                              .addQuery("access_token", _oauthToken)
                              .responseClass(SettingsItem);
    ...
    /**
     * The ID of the setting. The following IDs are valid:
     * <li>locale - The key to the user’s language/locale (BCP 47 identifier) that Glassware should use to render localized content.
     * <li>timezone - The key to the user’s current time zone region as defined in the tz database. Example: America/Los_Angeles.
     */ 
